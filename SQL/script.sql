...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_extension_de_contrato` (
  `extension_de_contrato` INT NOT NULL AUTO_INCREMENT,
  `opciones` VARCHAR(256) NULL,
  `periodo_de_validez` VARCHAR(256) NULL,
  `ids_expedientes` INT(11) NOT NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_condiciones_de_licitacion` (
  `condiciones_de_licitacion` INT NOT NULL AUTO_INCREMENT,
  `cv` TINYINT NULL,
  `admision_de_variantes` TINYINT NULL,
  `revision_de_precios` VARCHAR(256) NULL,
  `descripcion_programas_financiacion` VARCHAR(3400) NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `programa_de_financiacion` VARCHAR(5) NOT NULL,
  `ids_expedientes` INT(11) NOT NULL,
