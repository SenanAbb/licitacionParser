...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_postal_address` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_postal_address` (
  ...
  INDEX `fk_tbl_postal_address_tbl_address_format_code` (`addressformatcode` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_address_line` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_address_line` (
  ...
  INDEX `fk_tbl_address_line_tbl_postal_address1_idx` (`postaladdress` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_contact` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_ids` (
  ...
  PRIMARY KEY (`ids`),
  INDEX `fk_tbl_ids_tbl_modosid` (`modosid` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_entrys` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_entrys` (
  ...
  `ids` INT NOT NULL,
  PRIMARY KEY (`entrys`),
  INDEX `fk_tbl_entrys_tbl_ids` (`ids` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_contract_folder_status` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_contract_folder_status` (
  ...
  INDEX `fk_tbl_contract_folder_status_tbl_entrys` (`entry` ASC),
  INDEX `fk_tbl_contract_folder_status_tbl_contract_folder_status_co_idx` (`contractfolderstatuscode` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_country` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_country` (
  ...
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`country`),
  INDEX `fk_tbl_country_tbl_identification_code` (`identificationcode` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_located_contracting_party` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_located_contracting_party` (
  ...
  INDEX `fk_tbl_located_contracting_party_tbl_contract_folder_status` (`contractfolderstatus` ASC),
  INDEX `fk_tbl_located_contracting_party_tbl_contracting_party_type_code` (`contractingpartytypecode` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_parent_located_party` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_parent_located_party` (
  ...
  INDEX `fk_tbl_parent_located_party_tbl_located_contracting_party1_idx` (`locatedcontractingparty` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_party` (
  ...
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`party`),
  INDEX `fk_tbl_party_tbl_located_contracting_party1_idx` (`locatedcontractingparty` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party_identification` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party_name` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party_partyidentification` ;

CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_party_partyidentification` (
  `party` INT NOT NULL,
  `partyidentification` INT NOT NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `fk_tbl_party_partyidentification_tbl_party` (`party` ASC),
  INDEX `fk_tbl_party_partyidentification_tbl_partyidenfication` (`partyidentification` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_parentlocatedparty_partyname` ;
...
CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_parentlocatedparty_partyname` (
  ...
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `fk_tbl_party_name_has_tbl_parent_located_party_tbl_parent_l_idx` (`parentlocatedparty` ASC),
  INDEX `fk_tbl_party_name_has_tbl_parent_located_party_tbl_party_na_idx` (`partyname` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party_partyname` ;

CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_party_partyname` (
  `partyname` INT NOT NULL,
  `party` INT NOT NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `fk_tbl_party_name_has_tbl_party_tbl_party1_idx` (`party` ASC),
  INDEX `fk_tbl_party_name_has_tbl_party_tbl_party_name1_idx` (`partyname` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party_contact` ;

CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_party_contact` (
  `contact` INT NOT NULL,
  `party` INT NOT NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `fk_tbl_contact_has_tbl_party_tbl_party1_idx` (`party` ASC),
  INDEX `fk_tbl_contact_has_tbl_party_tbl_contact1_idx` (`contact` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_party_postaladdress` ;

CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_party_postaladdress` (
  `postaladdress` INT NOT NULL,
  `party` INT NOT NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `fk_tbl_postal_address_has_tbl_party_tbl_party1_idx` (`party` ASC),
  INDEX `fk_tbl_postal_address_has_tbl_party_tbl_postal_address1_idx` (`postaladdress` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `licitacion`.`tbl_postaladdress_country` ;

CREATE TABLE IF NOT EXISTS `licitacion`.`tbl_postaladdress_country` (
  `country` INT NOT NULL,
  `postaladdress` INT NOT NULL,
  `fecha_actualizacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `fk_tbl_country_has_tbl_postal_address_tbl_postal_address1_idx` (`postaladdress` ASC),
  INDEX `fk_tbl_country_has_tbl_postal_address_tbl_country1_idx` (`country` ASC),
...
START TRANSACTION;
USE `licitacion`;
INSERT INTO `licitacion`.`tbl_contracting_party_type_code` (`contracting_party_type_code`, `nombre`) VALUES (1, 'Administración General del Estado');
INSERT INTO `licitacion`.`tbl_contracting_party_type_code` (`contracting_party_type_code`, `nombre`) VALUES (2, 'Comunidad Autónoma');
INSERT INTO `licitacion`.`tbl_contracting_party_type_code` (`contracting_party_type_code`, `nombre`) VALUES (3, 'Administración Local');
INSERT INTO `licitacion`.`tbl_contracting_party_type_code` (`contracting_party_type_code`, `nombre`) VALUES (4, 'Entidad de Derecho Público ');
INSERT INTO `licitacion`.`tbl_contracting_party_type_code` (`contracting_party_type_code`, `nombre`) VALUES (5, 'Otras Entidades del Sector Público');

COMMIT;


-- -----------------------------------------------------
-- Data for table `licitacion`.`tbl_identification_code`
-- -----------------------------------------------------
START TRANSACTION;
USE `licitacion`;
INSERT INTO `licitacion`.`tbl_identification_code` (`identification_code`, `name`, `numericcode`) VALUES ('ES', 'Spain', 724);
